...
-- Module  Version: 1.2
--C:\lscc\diamond\3.10_x64\ispfpga\bin\nt64\scuba.exe -w -n efb_i2c_VHDL -lang vhdl -synth synplify -bus_exp 7 -bb -type efb -arch xo2c00 -freq 133.00 -i2c1 -i2c1_freq 400 -i2c1_sa 1000001 -i2c1_addr 7 -wb -dev 1200 

-- Tue Aug 20 12:53:44 2019
...
architecture Structure of efb_i2c_VHDL is
...
begin
    ...
    EFBInst_0: EFB
        ...
        SPI_LSB_FIRST=> "DISABLED", SPI_CLK_DIVIDER=>  3, SPI_MODE=> "MASTER", 
        ...
        I2C1_BUS_PERF=> "400kHz", I2C1_SLAVE_ADDR=> "0b1000001", 
        I2C1_ADDRESSING=> "7BIT", EFB_I2C1=> "ENABLED", EFB_WB_CLK_FREQ=> "133.0")
        port map (WBCLKI=>wb_clk_i, WBRSTI=>wb_rst_i, WBCYCI=>wb_cyc_i, 
            ...
            TCOC=>open, WBCUFMIRQ=>open, CFGWAKE=>open, CFGSTDBY=>open);
