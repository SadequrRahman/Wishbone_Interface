...
-- entity HeartBeatInst0_SLICE_0
  library IEEE, vital2000, MACHXO2;
  use IEEE.STD_LOGIC_1164.all;
  use vital2000.vital_timing.all;
  use MACHXO2.COMPONENTS.ALL;

  entity HeartBeatInst0_SLICE_0 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "HeartBeatInst0_SLICE_0";
    ...
    ATTRIBUTE Vital_Level0 OF HeartBeatInst0_SLICE_0 : ENTITY IS TRUE;

  end HeartBeatInst0_SLICE_0;

  architecture Structure of HeartBeatInst0_SLICE_0 is
...
-- entity top_module
  ...
  entity top_module is
    port (rst_n: in Std_logic; scl: in Std_logic; sda: in Std_logic; 
  ...
  architecture Structure of top_module is
    ...
    signal VCCI: Std_logic;
    component HeartBeatInst0_SLICE_0
      port (A1: in Std_logic; DI1: in Std_logic; CLK: in Std_logic; 
            F1: out Std_logic; Q1: out Std_logic; FCO: out Std_logic);
    end component;
  ...
  begin
    HeartBeatInst0_SLICE_0I: HeartBeatInst0_SLICE_0
      port map (A1=>HeartBeatInst0_iCounter_0, 
                DI1=>HeartBeatInst0_iCounter_s_0, CLK=>sys_clk, 
