...
-- Netlist created on Wed Oct 09 16:59:53 2019
-- Netlist written on Wed Oct 09 16:59:54 2019
...
-- entity i2c_controller_inst_SLICE_14
  library IEEE, vital2000, MACHXO2;
  use IEEE.STD_LOGIC_1164.all;
  use vital2000.vital_timing.all;
  use MACHXO2.COMPONENTS.ALL;

  entity i2c_controller_inst_SLICE_14 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "i2c_controller_inst_SLICE_14";
    ...
    ATTRIBUTE Vital_Level0 OF i2c_controller_inst_SLICE_14 : ENTITY IS TRUE;

  end i2c_controller_inst_SLICE_14;

  architecture Structure of i2c_controller_inst_SLICE_14 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    i2c_controller_inst_ack_o_0_sqmuxa_0_a2_0: lut40009
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    i2c_controller_inst_cState_3: vmuxregsre0004
      port map (D0=>M1_dly, D1=>VCCI, SD=>GNDI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    i2c_controller_inst_status_1_ret: vmuxregsre0004
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
...
-- entity i2c_controller_inst_SLICE_19
  library IEEE, vital2000, MACHXO2;
  use IEEE.STD_LOGIC_1164.all;
  use vital2000.vital_timing.all;
  use MACHXO2.COMPONENTS.ALL;

  entity i2c_controller_inst_SLICE_19 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "i2c_controller_inst_SLICE_19";
    ...
    ATTRIBUTE Vital_Level0 OF i2c_controller_inst_SLICE_19 : ENTITY IS TRUE;

  end i2c_controller_inst_SLICE_19;

  architecture Structure of i2c_controller_inst_SLICE_19 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    i2c_controller_inst_un1_nState_1_sqmuxa_0_o2_1: lut40010
      port map (A=>A1_ipd, B=>B1_ipd, C=>GNDI, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    i2c_controller_inst_un1_nState_1_sqmuxa_0_o2_2: lut40011
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>GNDI, Z=>F0_out);
    i2c_controller_inst_cState_ret_2: vmuxregsre0004
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    ...
    VitalBehavior : PROCESS (B1_ipd, A1_ipd, C0_ipd, B0_ipd, A0_ipd, DI1_dly, 
      DI0_dly, CLK_dly, F0_out, Q0_out, F1_out, Q1_out)
    VARIABLE F0_zd         	: std_logic := 'X';
    VARIABLE F0_GlitchData 	: VitalGlitchDataType;
    VARIABLE Q0_zd         	: std_logic := 'X';
    VARIABLE Q0_GlitchData 	: VitalGlitchDataType;
...
-- entity lut40012
  ...
  begin
    INST10: ROM16X1A
      generic map (initval => X"4C4C")
      port map (AD0=>A, AD1=>B, AD2=>C, AD3=>D, DO0=>Z);
  end Structure;

-- entity i2c_controller_inst_SLICE_24
  library IEEE, vital2000, MACHXO2;
  use IEEE.STD_LOGIC_1164.all;
  use vital2000.vital_timing.all;
  use MACHXO2.COMPONENTS.ALL;

  entity i2c_controller_inst_SLICE_24 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "i2c_controller_inst_SLICE_24";
    ...
    ATTRIBUTE Vital_Level0 OF i2c_controller_inst_SLICE_24 : ENTITY IS TRUE;

  end i2c_controller_inst_SLICE_24;

  architecture Structure of i2c_controller_inst_SLICE_24 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    i2c_controller_inst_un1_nState_1_sqmuxa_0_a2_2: lut40012
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    i2c_controller_inst_cState_0: vmuxregsre0004
      port map (D0=>M1_dly, D1=>VCCI, SD=>GNDI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    i2c_controller_inst_cState_ret_3: vmuxregsre0004
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
...
-- entity SLICE_29
  ...
  begin
    VCC_000_BUF1_BUF1: lut40013
      port map (A=>GNDI, B=>GNDI, C=>GNDI, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    nState_0_res_reg: vmuxregsre0014
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
...
-- entity SLICE_30
  ...
  begin
    VCC_002_BUF1_BUF1: lut40013
      port map (A=>GNDI, B=>GNDI, C=>GNDI, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    nState_0_res_lat: vmuxregsre0014
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
...
-- entity SLICE_32
  ...
  begin
    VCC_001_BUF1_BUF1: lut40013
      port map (A=>GNDI, B=>GNDI, C=>GNDI, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    nState_1_res_lat: vmuxregsre0014
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
...
-- entity SLICE_36
  ...
  begin
    ...
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    i2c_controller_inst_cState_4: vmuxregsre0004
      port map (D0=>M1_dly, D1=>VCCIS, SD=>GNDI, SP=>VCCIS, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCIS);
    wb_manager_inst_cState_5: vmuxregsre0015
...
-- entity SLICE_37
  ...
  begin
    wb_manager_inst_nState_1_sqmuxa_4_6: lut40016
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    wb_manager_inst_wb_dat_i_i_o2_0_7: lut40010
      port map (A=>A0_ipd, B=>B0_ipd, C=>GNDI, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    i2c_controller_inst_cState_0_10: vmuxregsre0004
      port map (D0=>M1_dly, D1=>VCCI, SD=>GNDI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
...
-- entity wb_manager_inst_SLICE_38
  ...
  begin
    wb_manager_inst_wb_adr_i_i_o2_0_0: lut40017
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    wb_manager_inst_wb_dat_i_i_o2_0_6: lut40010
      port map (A=>A0_ipd, B=>B0_ipd, C=>GNDI, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
...
-- entity wb_manager_inst_SLICE_39
  library IEEE, vital2000, MACHXO2;
  use IEEE.STD_LOGIC_1164.all;
  use vital2000.vital_timing.all;
  use MACHXO2.COMPONENTS.ALL;

  entity wb_manager_inst_SLICE_39 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "wb_manager_inst_SLICE_39";
    ...
    ATTRIBUTE Vital_Level0 OF wb_manager_inst_SLICE_39 : ENTITY IS TRUE;

  end wb_manager_inst_SLICE_39;

  architecture Structure of wb_manager_inst_SLICE_39 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    wb_manager_inst_nState_1_0_0_1: lut40018
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    wb_manager_inst_nState_1_sqmuxa_2_0_a2: lut40019
      port map (A=>A0_ipd, B=>B0_ipd, C=>GNDI, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    wb_manager_inst_nState_1: vmuxregsre0014
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    wb_manager_inst_nState_0: vmuxregsre0014
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
...
-- entity wb_manager_inst_SLICE_40
  library IEEE, vital2000, MACHXO2;
  use IEEE.STD_LOGIC_1164.all;
  use vital2000.vital_timing.all;
  use MACHXO2.COMPONENTS.ALL;

  entity wb_manager_inst_SLICE_40 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "wb_manager_inst_SLICE_40";
    ...
    ATTRIBUTE Vital_Level0 OF wb_manager_inst_SLICE_40 : ENTITY IS TRUE;

  end wb_manager_inst_SLICE_40;

  architecture Structure of wb_manager_inst_SLICE_40 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    wb_manager_inst_efb_i2c_Inst0_un1_cState_3: lut40010
      port map (A=>A1_ipd, B=>B1_ipd, C=>GNDI, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    wb_manager_inst_timeoutIns_op_ge_un3_timeoutlto8_1: lut40020
      port map (A=>A0_ipd, B=>B0_ipd, C=>GNDI, D=>GNDI, Z=>F0_out);
    wb_manager_inst_nState_3: vmuxregsre0014
      port map (D0=>M1_dly, D1=>VCCI, SD=>GNDI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    wb_manager_inst_nState_2: vmuxregsre0014
...
-- entity wb_manager_inst_SLICE_41
  library IEEE, vital2000, MACHXO2;
  use IEEE.STD_LOGIC_1164.all;
  use vital2000.vital_timing.all;
  use MACHXO2.COMPONENTS.ALL;

  entity wb_manager_inst_SLICE_41 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "wb_manager_inst_SLICE_41";
    ...
    ATTRIBUTE Vital_Level0 OF wb_manager_inst_SLICE_41 : ENTITY IS TRUE;

  end wb_manager_inst_SLICE_41;

  architecture Structure of wb_manager_inst_SLICE_41 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    wb_manager_inst_cState_RNIPLK1_2: lut40010
      port map (A=>A1_ipd, B=>B1_ipd, C=>GNDI, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    wb_manager_inst_nState_RNO_4: lut40006
      port map (A=>A0_ipd, B=>B0_ipd, C=>GNDI, D=>GNDI, Z=>F0_out);
    wb_manager_inst_nState_4: vmuxregsre0014
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
...
-- entity lut40021
  ...
  begin
    INST10: ROM16X1A
      generic map (initval => X"FDEC")
      port map (AD0=>A, AD1=>B, AD2=>C, AD3=>D, DO0=>Z);
  end Structure;

-- entity vmuxregsre0022
  library IEEE, vital2000, MACHXO2;
  use IEEE.STD_LOGIC_1164.all;
  use vital2000.vital_timing.all;
  use MACHXO2.COMPONENTS.ALL;

  entity vmuxregsre0022 is
    port (D0: in Std_logic; D1: in Std_logic; SD: in Std_logic; 
          SP: in Std_logic; CK: in Std_logic; LSR: in Std_logic; 
          Q: out Std_logic);

    ATTRIBUTE Vital_Level0 OF vmuxregsre0022 : ENTITY IS TRUE;

  end vmuxregsre0022;

  architecture Structure of vmuxregsre0022 is
    signal GATE: Std_logic;
  begin
    INST50: AND2
      port map (A=>SP, B=>CK, Z=>GATE);
...
-- entity wb_manager_inst_SLICE_42
  library IEEE, vital2000, MACHXO2;
  use IEEE.STD_LOGIC_1164.all;
  use vital2000.vital_timing.all;
  use MACHXO2.COMPONENTS.ALL;

  entity wb_manager_inst_SLICE_42 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "wb_manager_inst_SLICE_42";
    ...
    ATTRIBUTE Vital_Level0 OF wb_manager_inst_SLICE_42 : ENTITY IS TRUE;

  end wb_manager_inst_SLICE_42;

  architecture Structure of wb_manager_inst_SLICE_42 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
    ...
    component vmuxregsre0022
      port (D0: in Std_logic; D1: in Std_logic; SD: in Std_logic; 
            SP: in Std_logic; CK: in Std_logic; LSR: in Std_logic; 
            Q: out Std_logic);
    end component;
  begin
    wb_manager_inst_efb_i2c_Inst0_EFBInst_0_RNO: lut40006
      port map (A=>A1_ipd, B=>B1_ipd, C=>GNDI, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    wb_manager_inst_nState_1_0_5: lut40021
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
    wb_manager_inst_nState_5: vmuxregsre0022
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
...
-- entity SLICE_43
  ...
  begin
    wb_manager_inst_wb_dat_i_i_0_7: lut40023
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    wb_manager_inst_efb_i2c_Inst0_EFBInst_0_RNO_3: lut40024
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
    i2c_controller_inst_nState_5: vmuxregsre0014
      port map (D0=>M1_dly, D1=>VCCI, SD=>GNDI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    i2c_controller_inst_nState_4: vmuxregsre0014
      port map (D0=>M0_dly, D1=>VCCI, SD=>GNDI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
...
-- entity SLICE_44
  ...
  begin
    wb_manager_inst_nState_1_sqmuxa_4_0: lut40025
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    wb_manager_inst_timeoutIns_op_ge_un3_timeoutlto8_3: lut40026
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
    i2c_controller_inst_cState_0_8: vmuxregsre0004
      port map (D0=>M1_dly, D1=>VCCI, SD=>GNDI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    i2c_controller_inst_cState_0_7: vmuxregsre0004
      port map (D0=>M0_dly, D1=>VCCI, SD=>GNDI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
...
-- entity SLICE_45
  ...
  begin
    wb_manager_inst_wb_dat_i_i_a2_7: lut40027
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    wb_manager_inst_efb_i2c_Inst0_EFBInst_0_RNO_1: lut40028
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>GNDI, Z=>F0_out);
    i2c_controller_inst_nState_1: vmuxregsre0014
      port map (D0=>M1_dly, D1=>VCCI, SD=>GNDI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    i2c_controller_inst_nState_11: vmuxregsre0022
      port map (D0=>M0_dly, D1=>VCCI, SD=>GNDI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
...
-- entity SLICE_46
  ...
  begin
    wb_manager_inst_wb_adr_i_i_2_6: lut40011
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    wb_manager_inst_efb_i2c_Inst0_EFBInst_0_RNO_0: lut40029
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
    i2c_controller_inst_nState_10: vmuxregsre0014
      port map (D0=>M1_dly, D1=>VCCI, SD=>GNDI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    i2c_controller_inst_nState_0: vmuxregsre0014
      port map (D0=>M0_dly, D1=>VCCI, SD=>GNDI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
...
-- entity SLICE_47
  ...
  begin
    wb_manager_inst_wb_dat_i_i_o2_1: lut40030
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    wb_manager_inst_efb_i2c_Inst0_EFBInst_0_RNO_4: lut40031
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
    i2c_controller_inst_nState_7: vmuxregsre0014
      port map (D0=>M1_dly, D1=>VCCI, SD=>GNDI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    i2c_controller_inst_nState_6: vmuxregsre0014
      port map (D0=>M0_dly, D1=>VCCI, SD=>GNDI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
...
-- entity SLICE_48
  ...
  begin
    wb_manager_inst_nState_1_sqmuxa_4_2: lut40007
      port map (A=>A1_ipd, B=>B1_ipd, C=>GNDI, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    wb_manager_inst_nState_1_sqmuxa_4_i: lut40032
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
    i2c_controller_inst_cState_0_6: vmuxregsre0004
      port map (D0=>M1_dly, D1=>VCCI, SD=>GNDI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    i2c_controller_inst_cState_0_11: vmuxregsre0015
      port map (D0=>M0_dly, D1=>VCCI, SD=>GNDI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
...
-- entity SLICE_49
  ...
  begin
    wb_manager_inst_wb_dat_i_i_o2_RNIIBDF_1: lut40033
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    wb_manager_inst_efb_i2c_Inst0_EFBInst_0_RNO_5: lut40031
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
    i2c_controller_inst_nState_9: vmuxregsre0014
      port map (D0=>M1_dly, D1=>VCCI, SD=>GNDI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    i2c_controller_inst_nState_8: vmuxregsre0014
      port map (D0=>M0_dly, D1=>VCCI, SD=>GNDI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
...
-- entity SLICE_50
  ...
  begin
    wb_manager_inst_efb_i2c_Inst0_un1_i2c_ack_0_a2: lut40034
      port map (A=>A1_ipd, B=>B1_ipd, C=>GNDI, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    wb_manager_inst_efb_i2c_Inst0_un1_i2c_data_i6_0: lut40035
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>GNDI, Z=>F0_out);
    nState_1_res_reg_0: vmuxregsre0022
    ...
    VitalBehavior : PROCESS (B1_ipd, A1_ipd, C0_ipd, B0_ipd, A0_ipd, LSR_dly, 
...
-- entity SLICE_51
  ...
  begin
    ...
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    wb_manager_inst_efb_i2c_Inst0_EFBInst_0_RNO_2: lut40036
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
    i2c_controller_inst_nState_3: vmuxregsre0014
      port map (D0=>M1_dly, D1=>VCCI, SD=>GNDI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    i2c_controller_inst_nState_2: vmuxregsre0014
      port map (D0=>M0_dly, D1=>VCCI, SD=>GNDI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
...
-- entity SLICE_52
  ...
  begin
    wb_manager_inst_efb_i2c_Inst0_i2c_data_i4_0_a2: lut40007
      port map (A=>A1_ipd, B=>B1_ipd, C=>GNDI, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    i2c_controller_inst_cState_ret_3_RNI0QFB: lut40037
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>GNDI, Z=>F0_out);
    i2c_controller_inst_cState_2: vmuxregsre0004
      port map (D0=>M1_dly, D1=>VCCI, SD=>GNDI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    i2c_controller_inst_cState_1: vmuxregsre0004
      port map (D0=>M0_dly, D1=>VCCI, SD=>GNDI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
...
-- entity SLICE_53
  ...
  begin
    wb_manager_inst_efb_i2c_Inst0_EFBInst_0_RNO_6: lut40038
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    wb_manager_inst_wb_adr_i_i_a2_2: lut40007
      port map (A=>A0_ipd, B=>B0_ipd, C=>GNDI, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    ...
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    i2c_controller_inst_cState_0_9: vmuxregsre0004
      port map (D0=>M0_dly, D1=>VCCI, SD=>GNDI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
...
-- entity xo2iobuf0039
  ...
  entity xo2iobuf0039 is
    port (Z: out Std_logic; PAD: in Std_logic);

    ATTRIBUTE Vital_Level0 OF xo2iobuf0039 : ENTITY IS TRUE;

  end xo2iobuf0039;

  architecture Structure of xo2iobuf0039 is
  begin
    INST1: IBPD
      port map (I=>PAD, O=>Z);
  end Structure;
...
-- entity rst_nB
  ...
  architecture Structure of rst_nB is
    ...
    component xo2iobuf0039
      port (Z: out Std_logic; PAD: in Std_logic);
    end component;
  begin
    rst_n_pad: xo2iobuf0039
...
-- entity xo2iobuf0040
  ...
  entity xo2iobuf0040 is
    port (I: in Std_logic; T: in Std_logic; Z: out Std_logic; 
          PAD: out Std_logic; PADI: in Std_logic);

    ATTRIBUTE Vital_Level0 OF xo2iobuf0040 : ENTITY IS TRUE;

  end xo2iobuf0040;

  architecture Structure of xo2iobuf0040 is
  begin
    INST1: IBPD
      port map (I=>PADI, O=>Z);
    INST2: OBZPD
...
-- entity sclB
  ...
  architecture Structure of sclB is
    ...
    component xo2iobuf0040
      port (I: in Std_logic; T: in Std_logic; Z: out Std_logic; 
            PAD: out Std_logic; PADI: in Std_logic);
    end component;
  begin
    wb_manager_inst_efb_i2c_Inst0_BB1_scl: xo2iobuf0040
...
-- entity sdaB
  ...
  begin
    wb_manager_inst_efb_i2c_Inst0_BB1_sda: xo2iobuf0040
...
-- entity wb_manager_inst_efb_i2c_Inst0_EFBInst_0
  ...
  entity wb_manager_inst_efb_i2c_Inst0_EFBInst_0 is
    port (WBCLKI: in Std_logic; WBRSTI: in Std_logic; WBCYCI: in Std_logic; 
          ...
          WBDATI2: in Std_logic; WBDATI4: in Std_logic; WBDATI5: in Std_logic; 
  ...
  begin
    wb_manager_inst_efb_i2c_Inst0_EFBInst_0_EFB: EFBB
      port map (WBCLKI=>WBCLKI, WBRSTI=>WBRSTI_NOTIN, WBCYCI=>WBCYCI, 
                ...
                WBDATI1=>WBDATI1, WBDATI2=>WBDATI2, WBDATI3=>GNDI, 
                WBDATI4=>WBDATI4, WBDATI5=>WBDATI5, WBDATI6=>WBDATI6, 
...
-- entity top_module
  ...
  architecture Structure of top_module is
    ...
    signal wb_manager_inst_N_39_1_i: Std_logic;
    signal wb_manager_inst_N_39_1: Std_logic;
    ...
    signal wb_manager_inst_clk_counter_7: Std_logic;
    ...
    signal i2c_controller_inst_i2c_ack_reti: Std_logic;
    signal i2c_controller_inst_nState_3: Std_logic;
    signal i2c_ack: Std_logic;
    signal i2c_controller_inst_cState_3: Std_logic;
    signal i2c_controller_inst_nState_10: Std_logic;
    signal i2c_controller_inst_nState_7: Std_logic;
    signal N_38i: Std_logic;
    signal i2c_controller_inst_N_39_reti: Std_logic;
    signal i2c_controller_inst_N_40i: Std_logic;
    signal i2c_controller_inst_cState_ret_2: Std_logic;
    signal i2c_controller_inst_N_50_reti: Std_logic;
    signal i2c_controller_inst_nState_0: Std_logic;
    signal i2c_controller_inst_cState_ret_3: Std_logic;
    signal i2c_controller_inst_cState_0: Std_logic;
    signal VCC_000_BUF1: Std_logic;
    signal i2c_data_i4: Std_logic;
    signal un1_cState_3: Std_logic;
    signal VCC_002_BUF1: Std_logic;
    signal un1_i2c_data_i6_0: Std_logic;
    signal VCC_001_BUF1: Std_logic;
    signal un1_i2c_ack_0_a2: Std_logic;
    signal i2c_controller_inst_nState_4: Std_logic;
    signal wb_manager_inst_nState_0_5: Std_logic;
    signal VCCS: Std_logic;
    signal wb_manager_inst_cState_5: Std_logic;
    signal i2c_controller_inst_cState_4: Std_logic;
    signal wb_manager_inst_nState_1_sqmuxa_4_0: Std_logic;
    signal i2c_controller_inst_nState_9: Std_logic;
    signal i2c_controller_inst_nState_6: Std_logic;
    signal wb_manager_inst_N_36i: Std_logic;
    signal wb_manager_inst_cState_ret: Std_logic;
    signal wb_manager_inst_nState_1_sqmuxa_4_6: Std_logic;
    signal i2c_controller_inst_cState_10: Std_logic;
    signal i2c_controller_inst_nState_8: Std_logic;
    signal wb_manager_inst_N_37_reti: Std_logic;
    ...
    signal wb_manager_inst_timeoutIns_un3_timeoutlto8_1: Std_logic;
    signal wb_manager_inst_N_29_i: Std_logic;
    signal wb_manager_inst_cState_0: Std_logic;
    signal wb_manager_inst_nState_1_5: Std_logic;
    signal wb_manager_inst_efb_i2c_Inst0_N_34_i: Std_logic;
    signal wb_manager_inst_wb_dat_i_i_0_7: Std_logic;
    signal wb_manager_inst_N_64: Std_logic;
    signal wb_manager_inst_N_54: Std_logic;
    signal i2c_controller_inst_un1_nState_1_sqmuxa_i: Std_logic;
    signal wb_manager_inst_efb_i2c_Inst0_N_18_i: Std_logic;
    signal wb_manager_inst_un3_timeoutlto8_3: Std_logic;
    signal i2c_controller_inst_cState_7: Std_logic;
    signal i2c_controller_inst_cState_8: Std_logic;
    signal i2c_controller_inst_cState_1: Std_logic;
    signal wb_manager_inst_efb_i2c_Inst0_N_42_i: Std_logic;
    signal i2c_controller_inst_nState_11: Std_logic;
    signal i2c_controller_inst_nState_1: Std_logic;
    signal i2c_controller_inst_cState_11: Std_logic;
    signal wb_manager_inst_wb_adr_i_i_2_6: Std_logic;
    ...
    signal wb_manager_inst_N_41: Std_logic;
    signal wb_manager_inst_efb_i2c_Inst0_N_20_i: Std_logic;
    signal wb_manager_inst_nState_1_sqmuxa_4_2: Std_logic;
    signal wb_manager_inst_efb_i2c_Inst0_N_22_i: Std_logic;
    signal wb_manager_inst_N_26_i: Std_logic;
    signal i2c_controller_inst_cState_9: Std_logic;
    signal wb_manager_inst_efb_i2c_Inst0_N_32_i: Std_logic;
    ...
    component i2c_controller_inst_SLICE_14
      port (C0: in Std_logic; B0: in Std_logic; A0: in Std_logic; 
            DI0: in Std_logic; M1: in Std_logic; CLK: in Std_logic; 
            F0: out Std_logic; Q0: out Std_logic; Q1: out Std_logic);
    end component;
    component i2c_controller_inst_SLICE_19
      port (B1: in Std_logic; A1: in Std_logic; C0: in Std_logic; 
            B0: in Std_logic; A0: in Std_logic; DI1: in Std_logic; 
            DI0: in Std_logic; CLK: in Std_logic; F0: out Std_logic; 
            Q0: out Std_logic; F1: out Std_logic; Q1: out Std_logic);
    end component;
    component i2c_controller_inst_SLICE_24
      port (C0: in Std_logic; B0: in Std_logic; A0: in Std_logic; 
            DI0: in Std_logic; M1: in Std_logic; CLK: in Std_logic; 
            F0: out Std_logic; Q0: out Std_logic; Q1: out Std_logic);
    end component;
    ...
    component wb_manager_inst_SLICE_39
      port (D1: in Std_logic; C1: in Std_logic; B1: in Std_logic; 
            A1: in Std_logic; B0: in Std_logic; A0: in Std_logic; 
            DI1: in Std_logic; DI0: in Std_logic; CLK: in Std_logic; 
            F0: out Std_logic; Q0: out Std_logic; F1: out Std_logic; 
    ...
    component wb_manager_inst_SLICE_40
      port (B1: in Std_logic; A1: in Std_logic; B0: in Std_logic; 
            A0: in Std_logic; M1: in Std_logic; M0: in Std_logic; 
            CLK: in Std_logic; F0: out Std_logic; Q0: out Std_logic; 
            F1: out Std_logic; Q1: out Std_logic);
    end component;
    component wb_manager_inst_SLICE_41
      port (B1: in Std_logic; A1: in Std_logic; B0: in Std_logic; 
            A0: in Std_logic; DI0: in Std_logic; CLK: in Std_logic; 
            F0: out Std_logic; Q0: out Std_logic; F1: out Std_logic);
    end component;
    component wb_manager_inst_SLICE_42
      port (B1: in Std_logic; A1: in Std_logic; D0: in Std_logic; 
            C0: in Std_logic; B0: in Std_logic; A0: in Std_logic; 
            DI0: in Std_logic; CLK: in Std_logic; F0: out Std_logic; 
            Q0: out Std_logic; F1: out Std_logic);
    ...
    component wb_manager_inst_efb_i2c_Inst0_EFBInst_0
      port (WBCLKI: in Std_logic; WBRSTI: in Std_logic; WBCYCI: in Std_logic; 
            ...
            WBDATI1: in Std_logic; WBDATI2: in Std_logic; 
            WBDATI4: in Std_logic; WBDATI5: in Std_logic; 
  ...
  begin
    wb_manager_inst_timeoutIns_SLICE_0I: wb_manager_inst_timeoutIns_SLICE_0
      port map (A1=>wb_manager_inst_timeoutIns_clk_counter_0, 
                ...
                CE=>wb_manager_inst_N_39_1_i, LSR=>wb_manager_inst_N_39_1, 
    ...
    wb_manager_inst_timeoutIns_SLICE_5I: wb_manager_inst_timeoutIns_SLICE_5
      port map (A1=>wb_manager_inst_clk_counter_8, 
                A0=>wb_manager_inst_clk_counter_7, 
                ...
                Q0=>wb_manager_inst_clk_counter_7, 
    ...
    SLICE_10I: SLICE_10
      port map (C0=>HeartBeatInst0_iCounter_2, B0=>HeartBeatInst0_iCounter_1, 
                ...
                M1=>wb_manager_inst_nState_1, CLK=>sys_clk, 
                F0=>HeartBeatInst0_iCounter_RNO_2, 
                Q0=>HeartBeatInst0_iCounter_2, Q1=>wb_manager_inst_cState_1);
    SLICE_11I: SLICE_11
      port map (B0=>nState_1_o3, A0=>nState_1_o1, DI0=>nState_1, 
                M1=>wb_manager_inst_nState_4, CLK=>sys_clk, F0=>nState_1, 
                Q0=>cState_1, Q1=>wb_manager_inst_cState_4);
    SLICE_12I: SLICE_12
      port map (B0=>nState_0_o3, A0=>nState_0_o2, DI0=>nState_0_0, 
                M1=>wb_manager_inst_nState_3, CLK=>sys_clk, F0=>nState_0_0, 
                Q0=>cState_0_0, Q1=>wb_manager_inst_cState_3);
    SLICE_13I: SLICE_13
      port map (D0=>heart_beat_c, C0=>HeartBeatInst0_iCounter_2, 
                ...
                M1=>wb_manager_inst_nState_2, CLK=>sys_clk, 
                F0=>HeartBeatInst0_iCounter_RNO_3, Q0=>heart_beat_c, 
                Q1=>wb_manager_inst_cState_2);
    i2c_controller_inst_SLICE_14I: i2c_controller_inst_SLICE_14
      port map (C0=>wb_manager_inst_cState_1, B0=>i2c_controller_inst_nState_5, 
                A0=>i2c_controller_inst_cState_ret_1, 
                DI0=>i2c_controller_inst_i2c_ack_reti, 
                M1=>i2c_controller_inst_nState_3, CLK=>sys_clk, 
                F0=>i2c_controller_inst_i2c_ack_reti, Q0=>i2c_ack, 
                Q1=>i2c_controller_inst_cState_3);
    i2c_controller_inst_SLICE_19I: i2c_controller_inst_SLICE_19
      port map (B1=>i2c_controller_inst_nState_10, 
                A1=>i2c_controller_inst_nState_7, 
                C0=>i2c_controller_inst_nState_7, 
                B0=>i2c_controller_inst_nState_10, A0=>N_38i, 
                DI1=>i2c_controller_inst_N_39_reti, 
                DI0=>i2c_controller_inst_N_40i, CLK=>sys_clk, 
                F0=>i2c_controller_inst_N_40i, 
                Q0=>i2c_controller_inst_cState_ret_1, 
                F1=>i2c_controller_inst_N_39_reti, 
                Q1=>i2c_controller_inst_cState_ret_2);
    i2c_controller_inst_SLICE_24I: i2c_controller_inst_SLICE_24
      port map (C0=>wb_manager_inst_cState_1, B0=>i2c_controller_inst_N_40i, 
                A0=>i2c_controller_inst_cState_ret_1, 
                DI0=>i2c_controller_inst_N_50_reti, 
                M1=>i2c_controller_inst_nState_0, CLK=>sys_clk, 
                F0=>i2c_controller_inst_N_50_reti, 
                Q0=>i2c_controller_inst_cState_ret_3, 
                Q1=>i2c_controller_inst_cState_0);
    SLICE_29I: SLICE_29
      port map (DI0=>VCC_000_BUF1, LSR=>i2c_data_i4, CLK=>un1_cState_3, 
                F0=>VCC_000_BUF1, Q0=>nState_0_o2);
    SLICE_30I: SLICE_30
      port map (DI0=>VCC_002_BUF1, LSR=>i2c_data_i4, CLK=>un1_i2c_data_i6_0, 
    ...
    SLICE_36I: SLICE_36
      port map (M1=>i2c_controller_inst_nState_4, 
                M0=>wb_manager_inst_nState_0_5, CLK=>sys_clk, F0=>VCCS, 
                Q0=>wb_manager_inst_cState_5, Q1=>i2c_controller_inst_cState_4);
    SLICE_37I: SLICE_37
      port map (D1=>wb_manager_inst_clk_counter_15, 
                C1=>wb_manager_inst_clk_counter_12, 
                B1=>wb_manager_inst_clk_counter_11, 
                A1=>wb_manager_inst_nState_1_sqmuxa_4_0, 
                B0=>i2c_controller_inst_nState_9, 
                A0=>i2c_controller_inst_nState_6, DI0=>wb_manager_inst_N_36i, 
                M1=>i2c_controller_inst_nState_10, CLK=>sys_clk, 
                F0=>wb_manager_inst_N_36i, Q0=>wb_manager_inst_cState_ret, 
                F1=>wb_manager_inst_nState_1_sqmuxa_4_6, 
                Q1=>i2c_controller_inst_cState_10);
    wb_manager_inst_SLICE_38I: wb_manager_inst_SLICE_38
      port map (D1=>i2c_controller_inst_nState_5, 
                C1=>i2c_controller_inst_nState_8, 
                B1=>i2c_controller_inst_nState_9, 
                A1=>i2c_controller_inst_nState_6, 
                B0=>i2c_controller_inst_nState_8, 
                A0=>i2c_controller_inst_nState_5, DI1=>N_38i, 
                DI0=>wb_manager_inst_N_37_reti, CLK=>sys_clk, 
                F0=>wb_manager_inst_N_37_reti, 
                Q0=>wb_manager_inst_cState_ret_1, F1=>N_38i, 
                Q1=>wb_manager_inst_cState_ret_2);
    wb_manager_inst_SLICE_39I: wb_manager_inst_SLICE_39
      port map (D1=>wb_manager_inst_wb_ack_o, C1=>wb_manager_inst_cState_2, 
                B1=>wb_manager_inst_cState_1, 
    ...
    wb_manager_inst_SLICE_40I: wb_manager_inst_SLICE_40
      port map (B1=>i2c_ack, A1=>cState_1, 
                B0=>wb_manager_inst_timeoutIns_clk_counter_6, 
                A0=>wb_manager_inst_timeoutIns_clk_counter_5, 
                M1=>wb_manager_inst_cState_4, M0=>wb_manager_inst_cState_3, 
                CLK=>wb_manager_inst_nState_1_sqmuxa_4_i, 
                F0=>wb_manager_inst_timeoutIns_un3_timeoutlto8_1, 
                Q0=>wb_manager_inst_nState_2, F1=>un1_cState_3, 
                Q1=>wb_manager_inst_nState_3);
    wb_manager_inst_SLICE_41I: wb_manager_inst_SLICE_41
      port map (B1=>wb_manager_inst_cState_2, A1=>wb_manager_inst_cState_3, 
                B0=>wb_manager_inst_cState_5, 
                A0=>i2c_controller_inst_cState_ret_1, 
                DI0=>wb_manager_inst_N_29_i, 
                CLK=>wb_manager_inst_nState_1_sqmuxa_4_i, 
                F0=>wb_manager_inst_N_29_i, Q0=>wb_manager_inst_nState_4, 
                F1=>wb_manager_inst_N_39_1_i);
    wb_manager_inst_SLICE_42I: wb_manager_inst_SLICE_42
      port map (B1=>wb_manager_inst_cState_3, 
                A1=>i2c_controller_inst_cState_ret_1, 
                D0=>wb_manager_inst_cState_5, C0=>wb_manager_inst_cState_1, 
                B0=>wb_manager_inst_cState_0, 
                A0=>i2c_controller_inst_cState_ret_1, 
                DI0=>wb_manager_inst_nState_1_5, 
                CLK=>wb_manager_inst_nState_1_sqmuxa_4_i, 
                F0=>wb_manager_inst_nState_1_5, Q0=>wb_manager_inst_nState_0_5, 
                F1=>wb_manager_inst_efb_i2c_Inst0_N_34_i);
    SLICE_43I: SLICE_43
      port map (C1=>cState_0_0, B1=>i2c_controller_inst_cState_ret_1, 
                A1=>wb_manager_inst_cState_ret, 
                D0=>wb_manager_inst_wb_dat_i_i_0_7, C0=>wb_manager_inst_N_64, 
                B0=>wb_manager_inst_N_54, A0=>wb_manager_inst_cState_ret, 
                M1=>i2c_controller_inst_cState_0, 
                M0=>i2c_controller_inst_cState_10, 
                CLK=>i2c_controller_inst_un1_nState_1_sqmuxa_i, 
                F0=>wb_manager_inst_efb_i2c_Inst0_N_18_i, 
                Q0=>i2c_controller_inst_nState_4, 
                F1=>wb_manager_inst_wb_dat_i_i_0_7, 
                Q1=>i2c_controller_inst_nState_5);
    SLICE_44I: SLICE_44
      port map (D1=>wb_manager_inst_un3_timeoutlto8_3, 
                C1=>wb_manager_inst_clk_counter_8, 
                B1=>wb_manager_inst_clk_counter_7, 
                A1=>wb_manager_inst_nState_1_sqmuxa_2, 
                D0=>wb_manager_inst_timeoutIns_un3_timeoutlto8_1, 
                C0=>wb_manager_inst_timeoutIns_clk_counter_4, 
                B0=>wb_manager_inst_timeoutIns_clk_counter_3, 
                A0=>wb_manager_inst_timeoutIns_clk_counter_2, 
                M1=>i2c_controller_inst_nState_8, 
                M0=>i2c_controller_inst_nState_7, CLK=>sys_clk, 
                F0=>wb_manager_inst_un3_timeoutlto8_3, 
                Q0=>i2c_controller_inst_cState_7, 
                F1=>wb_manager_inst_nState_1_sqmuxa_4_0, 
                Q1=>i2c_controller_inst_cState_8);
    SLICE_45I: SLICE_45
      port map (C1=>wb_manager_inst_cState_2, B1=>wb_manager_inst_cState_3, 
                A1=>wb_manager_inst_cState_4, 
                C0=>i2c_controller_inst_cState_ret_2, 
                B0=>i2c_controller_inst_cState_1, A0=>wb_manager_inst_N_54, 
                M1=>i2c_controller_inst_cState_7, M0=>i2c_ack, 
                CLK=>i2c_controller_inst_un1_nState_1_sqmuxa_i, 
                F0=>wb_manager_inst_efb_i2c_Inst0_N_42_i, 
                Q0=>i2c_controller_inst_nState_11, F1=>wb_manager_inst_N_54, 
                Q1=>i2c_controller_inst_nState_1);
    SLICE_46I: SLICE_46
      port map (C1=>i2c_controller_inst_cState_11, 
                B1=>i2c_controller_inst_cState_4, 
                A1=>i2c_controller_inst_cState_3, 
                D0=>wb_manager_inst_wb_adr_i_i_2_6, 
                C0=>i2c_controller_inst_cState_2, 
                B0=>i2c_controller_inst_cState_0, A0=>wb_manager_inst_N_54, 
                M1=>i2c_controller_inst_cState_11, 
                M0=>i2c_controller_inst_cState_6, 
                CLK=>i2c_controller_inst_un1_nState_1_sqmuxa_i, 
                F0=>wb_manager_inst_efb_i2c_Inst0_N_28_i, 
                Q0=>i2c_controller_inst_nState_0, 
                F1=>wb_manager_inst_wb_adr_i_i_2_6, 
                Q1=>i2c_controller_inst_nState_10);
    SLICE_47I: SLICE_47
      port map (C1=>i2c_controller_inst_cState_7, 
                B1=>i2c_controller_inst_cState_1, A1=>cState_0_0, 
                D0=>wb_manager_inst_N_54, C0=>wb_manager_inst_N_41, 
                B0=>i2c_controller_inst_cState_ret_1, 
                A0=>wb_manager_inst_cState_ret_1, 
                M1=>i2c_controller_inst_cState_2, 
                M0=>i2c_controller_inst_cState_1, 
                CLK=>i2c_controller_inst_un1_nState_1_sqmuxa_i, 
                F0=>wb_manager_inst_efb_i2c_Inst0_N_20_i, 
                Q0=>i2c_controller_inst_nState_6, F1=>wb_manager_inst_N_41, 
                Q1=>i2c_controller_inst_nState_7);
    SLICE_48I: SLICE_48
      port map (B1=>wb_manager_inst_clk_counter_14, 
                A1=>wb_manager_inst_clk_counter_13, 
                D0=>wb_manager_inst_clk_counter_10, 
                C0=>wb_manager_inst_clk_counter_9, 
                B0=>wb_manager_inst_nState_1_sqmuxa_4_6, 
                A0=>wb_manager_inst_nState_1_sqmuxa_4_2, 
                M1=>i2c_controller_inst_nState_6, 
                M0=>i2c_controller_inst_nState_11, CLK=>sys_clk, 
                F0=>wb_manager_inst_nState_1_sqmuxa_4_i, 
                Q0=>i2c_controller_inst_cState_11, 
                F1=>wb_manager_inst_nState_1_sqmuxa_4_2, 
                Q1=>i2c_controller_inst_cState_6);
    SLICE_49I: SLICE_49
      port map (C1=>wb_manager_inst_N_54, B1=>wb_manager_inst_N_41, 
                A1=>i2c_controller_inst_cState_ret_1, D0=>wb_manager_inst_N_54, 
                C0=>wb_manager_inst_N_41, B0=>i2c_controller_inst_cState_ret_1, 
                A0=>wb_manager_inst_cState_ret, 
                M1=>i2c_controller_inst_cState_4, 
                M0=>i2c_controller_inst_cState_3, 
                CLK=>i2c_controller_inst_un1_nState_1_sqmuxa_i, 
                F0=>wb_manager_inst_efb_i2c_Inst0_N_22_i, 
                Q0=>i2c_controller_inst_nState_8, F1=>wb_manager_inst_N_26_i, 
                Q1=>i2c_controller_inst_nState_9);
    SLICE_50I: SLICE_50
      port map (B1=>i2c_ack, A1=>cState_1, C0=>i2c_ack, B0=>cState_1, 
                A0=>cState_0_0, LSR=>un1_i2c_ack_0_a2, CLK=>un1_cState_3, 
                F0=>un1_i2c_data_i6_0, Q0=>nState_1_o1, F1=>un1_i2c_ack_0_a2);
    SLICE_51I: SLICE_51
      port map (B1=>wb_manager_inst_cState_3, A1=>wb_manager_inst_cState_2, 
                D0=>wb_manager_inst_cState_4, C0=>wb_manager_inst_cState_3, 
                B0=>wb_manager_inst_cState_2, A0=>wb_manager_inst_cState_ret_2, 
                M1=>i2c_controller_inst_cState_9, 
                M0=>i2c_controller_inst_cState_8, 
                CLK=>i2c_controller_inst_un1_nState_1_sqmuxa_i, 
                F0=>wb_manager_inst_efb_i2c_Inst0_N_32_i, 
                Q0=>i2c_controller_inst_nState_2, F1=>wb_manager_inst_N_39_1, 
                Q1=>i2c_controller_inst_nState_3);
    SLICE_52I: SLICE_52
      port map (B1=>cState_0_0, A1=>cState_1, 
                C0=>i2c_controller_inst_cState_11, B0=>cState_0_0, 
                A0=>i2c_controller_inst_cState_ret_3, 
                M1=>i2c_controller_inst_nState_2, 
                M0=>i2c_controller_inst_nState_1, CLK=>sys_clk, 
                F0=>i2c_controller_inst_un1_nState_1_sqmuxa_i, 
                Q0=>i2c_controller_inst_cState_1, F1=>i2c_data_i4, 
                Q1=>i2c_controller_inst_cState_2);
    SLICE_53I: SLICE_53
      port map (D1=>i2c_controller_inst_cState_10, C1=>cState_0_0, 
                B1=>wb_manager_inst_N_54, A1=>wb_manager_inst_cState_ret_2, 
                B0=>i2c_controller_inst_cState_1, 
                A0=>i2c_controller_inst_cState_ret_2, 
                M1=>wb_manager_inst_nState_0, M0=>i2c_controller_inst_nState_9, 
                CLK=>sys_clk, F0=>wb_manager_inst_N_64, 
                Q0=>i2c_controller_inst_cState_9, 
                F1=>wb_manager_inst_efb_i2c_Inst0_N_24_i, 
                Q1=>wb_manager_inst_cState_0);
    enI2CI: enI2CB
    ...
    OSCInst0I: OSCInst0
      ...
      port map (WBCLKI=>sys_clk, WBRSTI=>rst_n_c, 
                WBCYCI=>wb_manager_inst_N_39_1_i, 
                WBSTBI=>wb_manager_inst_N_39_1_i, 
                WBWEI=>wb_manager_inst_efb_i2c_Inst0_N_34_i, 
                WBADRI0=>wb_manager_inst_efb_i2c_Inst0_N_32_i, 
                WBADRI2=>wb_manager_inst_efb_i2c_Inst0_N_42_i, 
                WBADRI6=>wb_manager_inst_efb_i2c_Inst0_N_28_i, 
                WBDATI1=>wb_manager_inst_N_26_i, 
                WBDATI2=>wb_manager_inst_efb_i2c_Inst0_N_24_i, 
                WBDATI4=>wb_manager_inst_efb_i2c_Inst0_N_22_i, 
                WBDATI5=>wb_manager_inst_N_26_i, 
                WBDATI6=>wb_manager_inst_efb_i2c_Inst0_N_20_i, 
                WBDATI7=>wb_manager_inst_efb_i2c_Inst0_N_18_i, 
